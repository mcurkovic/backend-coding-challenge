...
/**
 * A bean mapper designed for Spring suitable for dependency injection. Provides
 * an implementation of {@link MapperFacade} which can be injected. In addition
 * it is "Spring aware" in that it can autodiscover any implementations of
 * {@link Mapper} or {@link Converter} that are managed beans within it's parent
 * {@link ApplicationContext}.
 */
@Component
public class SpringConfigurableMapper extends ConfigurableMapper implements
